...
QUESTION RULES:
- Generate 3-5 short-answer questions, 3-5 long-answer questions, and 1 diagram-based question.
- For each question in "short" and "long" arrays, return an object containing the "question" string and a detailed, exam-focused "answer" string.
- For the "diagram" question, return an object containing the "question" string and a detailed "answer" string.
